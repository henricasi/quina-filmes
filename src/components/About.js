  ...
  return (
    <article className="list">
      ...
      <div className="about-content">
        <a href="/img/angela/angela_still4_1316x740.jpg" data-lightbox="gallery" className="about-picture-link"><img src="/img/angela/thumb-angela_still4.jpg" alt="a quina" className="about-picture"/></a>
